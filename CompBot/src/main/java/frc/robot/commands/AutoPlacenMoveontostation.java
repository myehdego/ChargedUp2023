...
public class AutoPlacenMoveontostation extends SequentialCommandGroup {
  /** Place game piece:
       ...
       */
  public AutoPlacenMoveontostation(Arm arm, SwerveSubsystem drive, Gripper gripper, PWM lights) {
